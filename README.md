...
- `Flatten()` layer breaks down the 2D image into a 1-dimensional vector to serve as input to the fully connected layer. The dense layer acts as the fully connected layer.
